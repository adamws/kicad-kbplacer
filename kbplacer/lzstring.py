...
# Copied from https://github.com/gkovacs/lz-string-python because
# working with KiCad's plugin system which is not yet supporting dependencies installation (KiCad <10).
# Will be replaced with package requirement when support for old KiCad versions dropped.
